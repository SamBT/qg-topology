...
// Wed Jan 23 11:15:16 2019 by ROOT version 6.14/04
// from TTree EventTree/Event Tree for FCNC
// found on file: /project/projectdirs/atlas/sambt/Pythia_output_final/lowpT/Dijets_100k_R0p4/Dijets_100k_R0p4.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/project/projectdirs/atlas/sambt/Pythia_output_final/lowpT/Dijets_100k_R0p4/Dijets_100k_R0p4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/project/projectdirs/atlas/sambt/Pythia_output_final/lowpT/Dijets_100k_R0p4/Dijets_100k_R0p4.root");
      }
