void qjet_vs_gjet_samesample(TString type, TString var, TString xlabel, int rebin, int logscale) {
  TString filename;
  if (type == "dijets") filename = "/global/homes/s/sambt/Jets/qg_tagging_topology_project/analysis/analysis_output/Radius_06/output_dijets_rewt.root";
  if (type == "zplusjets") filename = "/global/homes/s/sambt/Jets/qg_tagging_topology_project/analysis/analysis_output/Radius_06/output_zplusjets.root";
