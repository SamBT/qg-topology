void quark_vs_gluon_angularity_by_dR(TString type, TString var, TString xlabel, int rebin) {
  TString filename;
  ...
  c1->SaveAs("qjet_vs_gjet_"+var+"_sep_power_by_dR.png");
  c1->SaveAs("qjet_vs_gjet_"+var+"_sep_power_by_dR.pdf");
}
