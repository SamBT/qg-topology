...
void kappa_beta_samejet_sep(TString radius, TString type, int rebin, int isleading, int groomed) {
  ...
  if (type == "qjet") {
    samp1 = {"dijets","dijets","zplusjets","dijets","zplusjets"};
    samp2 = {"zplusjets","H2qqbar","H2qqbar","H2qqbar_boosted","H2qqbar_boosted"};
  }
  else {
    samp1 = {"dijets","dijets","zplusjets","qqbar2Zg","dijets","zplusjets"};
    samp2 = {"zplusjets","H2gg","H2gg","gg2Hg","H2gg_boosted","H2gg_boosted"};
  }
  ...
  for (int l = 0; l < sep_hists.size(); l++) {
    ...
    sep_hists[l]->GetYaxis()->SetRangeUser(0,0.062);
