...
int main (int argc, char **argv) {
  ...
  for( int i = 0 ; i < numev ; i ++ ) {	
	...
	h_qjet_pt->Fill(p->QCDaQjetPtSmallR->at(nqjets_filled));
        h_qjet_eta->Fill(p->QCDaQjetEtaSmallR->at(nqjets_filled));
        h_qjet_phi->Fill(p->QCDaQjetPhiSmallR->at(nqjets_filled));
        h_qjet_M->Fill(p->QCDaQjetMSmallR->at(nqjets_filled));
        h_qjet_multiplicity->Fill(p->QCDaQjetMultSmallR->at(nqjets_filled));
        h_qjet_ptD->Fill(p->QCDaQjetpTDSmallR->at(nqjets_filled));
        h_qjet_LHA->Fill(p->QCDaQjetLHASmallR->at(nqjets_filled));
        h_qjet_width->Fill(p->QCDaQjetWidthSmallR->at(nqjets_filled));
        h_qjet_mass->Fill(p->QCDaQjetMassSmallR->at(nqjets_filled));
	nqjets_filled += 1;
      }
      if (ngjets_filled+1 <= p->QCDaNGjetsSmallR && p->QCDaGjetPtSmallR->at(ngjets_filled) == p->JsmallPt->at(n)) {
	h_gjet_pt->Fill(p->QCDaGjetPtSmallR->at(ngjets_filled));
        h_gjet_eta->Fill(p->QCDaGjetEtaSmallR->at(ngjets_filled));
        h_gjet_phi->Fill(p->QCDaGjetPhiSmallR->at(ngjets_filled));
        h_gjet_M->Fill(p->QCDaGjetMSmallR->at(ngjets_filled));
        h_gjet_multiplicity->Fill(p->QCDaGjetMultSmallR->at(ngjets_filled));
        h_gjet_ptD->Fill(p->QCDaGjetpTDSmallR->at(ngjets_filled));
        h_gjet_LHA->Fill(p->QCDaGjetLHASmallR->at(ngjets_filled));
        h_gjet_width->Fill(p->QCDaGjetWidthSmallR->at(ngjets_filled));
        h_gjet_mass->Fill(p->QCDaGjetMassSmallR->at(ngjets_filled));
	ngjets_filled += 1;
      }
    }
