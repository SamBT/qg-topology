...
int main (int argc, char **argv) {
  ...
  for( int i = 0 ; i < numev ; i ++ ) {	
    ...
    for (int n = 0; n < max_index; n++) {
      if (p->JsmallPt->at(n) < 200 || p->JsmallPt->at(n) > 350 || fabs(p->JsmallEta->at(n)) > 2.0 || (isHiggsBoosted && p->JsmallM->at(n) > 80)) continue;
	...
	h_qjet_pt->Fill(p->QjetPtSmallR->at(nqjets_filled),wt_pt);
        h_qjet_eta->Fill(p->QjetEtaSmallR->at(nqjets_filled),wt_eta);
        h_qjet_phi->Fill(p->QjetPhiSmallR->at(nqjets_filled),wt);
        h_qjet_M->Fill(p->QjetMSmallR->at(nqjets_filled),wt);
        h_qjet_multiplicity->Fill(p->QjetMultSmallR->at(nqjets_filled),wt);
        h_qjet_ptD->Fill(p->QjetpTDSmallR->at(nqjets_filled),wt);
        h_qjet_LHA->Fill(p->QjetLHASmallR->at(nqjets_filled),wt);
        h_qjet_width->Fill(p->QjetWidthSmallR->at(nqjets_filled),wt);
        h_qjet_mass->Fill(p->QjetMassSmallR->at(nqjets_filled),wt);
	nqjets_filled += 1;
      }
	...
	h_gjet_pt->Fill(p->GjetPtSmallR->at(ngjets_filled),wt_pt);
        h_gjet_eta->Fill(p->GjetEtaSmallR->at(ngjets_filled),wt_eta);
        h_gjet_phi->Fill(p->GjetPhiSmallR->at(ngjets_filled),wt);
        h_gjet_M->Fill(p->GjetMSmallR->at(ngjets_filled),wt);
        h_gjet_multiplicity->Fill(p->GjetMultSmallR->at(ngjets_filled),wt);
        h_gjet_ptD->Fill(p->GjetpTDSmallR->at(ngjets_filled),wt);
        h_gjet_LHA->Fill(p->GjetLHASmallR->at(ngjets_filled),wt);
        h_gjet_width->Fill(p->GjetWidthSmallR->at(ngjets_filled),wt);
        h_gjet_mass->Fill(p->GjetMassSmallR->at(ngjets_filled),wt);
	ngjets_filled += 1;
      }
    }
