...
#../bin/QCDa_highpt_analysis_groomed ${path}/H2gg_ee_1M_R${r}/H2gg_ee_1M_R${r}.root
#mv output.root ${path2}/output_groomed_H2gg_ee.root

#../bin/QCDa_highpt_analysis_groomed ${path}/H2qqbar_ee_1M_R${r}/H2qqbar_ee_1M_R${r}.root
...
#../bin/QCDa_highpt_analysis_groomed_rewt ${path2}/output_H2gg_ee.root ${path2}/output_zplusjets.root ${path}/H2gg_ee_1M_R${r}/H2gg_ee_1M_R${r}.root
#mv output.root ${path2}/output_groomed_H2gg_ee_rewt.root

#../bin/QCDa_highpt_analysis_groomed_rewt ${path2}/output_H2qqbar_ee.root ${path2}/output_zplusjets.root ${path}/H2qqbar_ee_1M_R${r}/H2qqbar_ee_1M_R${r}.root
