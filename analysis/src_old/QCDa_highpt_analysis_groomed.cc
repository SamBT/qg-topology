...
int main (int argc, char **argv) {
  ...
  for( int i = 0 ; i < numev ; i ++ ) {	
    ...
    for (int k = 0; k < p->QCDaNQjetsSmallR; k++) {
      test_hist_q->Fill(p->QCDaQjetLHASmallR_SD->at(k));
      if (p->QCDaQjetPtSmallR->at(k) < 200 || p->QCDaQjetPtSmallR->at(k) > 400 || fabs(p->QCDaQjetEtaSmallR->at(k)) > 2.0) continue;
      h_qjet_pt->Fill(p->QCDaQjetPtSmallR_SD->at(k));
      h_qjet_eta->Fill(p->QCDaQjetEtaSmallR_SD->at(k));
      h_qjet_phi->Fill(p->QCDaQjetPhiSmallR_SD->at(k));
      h_qjet_M->Fill(p->QCDaQjetMSmallR_SD->at(k));
      h_qjet_multiplicity->Fill(p->QCDaQjetMultSmallR_SD->at(k));
      h_qjet_ptD->Fill(p->QCDaQjetpTDSmallR_SD->at(k));
      h_qjet_LHA->Fill(p->QCDaQjetLHASmallR_SD->at(k));
      h_qjet_width->Fill(p->QCDaQjetWidthSmallR_SD->at(k));
      h_qjet_mass->Fill(p->QCDaQjetMassSmallR_SD->at(k));
	...
	h_qjet_subleading_pt->Fill(p->QCDaQjetPtSmallR_SD->at(k));
      ...
      h_qjet_multiplicity_eta->Fill(p->QCDaQjetMultSmallR_SD->at(k),p->QCDaQjetEtaSmallR_SD->at(k));
      h_qjet_ptD_eta->Fill(p->QCDaQjetpTDSmallR_SD->at(k),p->QCDaQjetEtaSmallR_SD->at(k));
      h_qjet_LHA_eta->Fill(p->QCDaQjetLHASmallR_SD->at(k),p->QCDaQjetEtaSmallR_SD->at(k));
      h_qjet_width_eta->Fill(p->QCDaQjetWidthSmallR_SD->at(k),p->QCDaQjetEtaSmallR_SD->at(k));
      h_qjet_mass_eta->Fill(p->QCDaQjetMassSmallR_SD->at(k),p->QCDaQjetEtaSmallR_SD->at(k));
	...
	if (p->JsmallPt->at(l) < 20) continue;
      ...
      h_qjet_multiplicity_nearestdR->Fill(p->QCDaQjetMultSmallR_SD->at(k),dRmin);
      h_qjet_ptD_nearestdR->Fill(p->QCDaQjetpTDSmallR_SD->at(k),dRmin);
      h_qjet_LHA_nearestdR->Fill(p->QCDaQjetLHASmallR_SD->at(k),dRmin);
      h_qjet_width_nearestdR->Fill(p->QCDaQjetWidthSmallR_SD->at(k),dRmin);
      h_qjet_mass_nearestdR->Fill(p->QCDaQjetMassSmallR_SD->at(k),dRmin);
    }
    ...
    for (int j = 0; j < p->QCDaNGjetsSmallR; j++) {
      ...
      h_gjet_pt->Fill(p->QCDaGjetPtSmallR_SD->at(j));
      h_gjet_eta->Fill(p->QCDaGjetEtaSmallR_SD->at(j));
      h_gjet_phi->Fill(p->QCDaGjetPhiSmallR_SD->at(j));
      h_gjet_M->Fill(p->QCDaGjetMSmallR_SD->at(j));
      h_gjet_multiplicity->Fill(p->QCDaGjetMultSmallR_SD->at(j));
      h_gjet_ptD->Fill(p->QCDaGjetpTDSmallR_SD->at(j));
      h_gjet_LHA->Fill(p->QCDaGjetLHASmallR_SD->at(j));
      h_gjet_width->Fill(p->QCDaGjetWidthSmallR_SD->at(j));
      h_gjet_mass->Fill(p->QCDaGjetMassSmallR_SD->at(j));
	...
	h_gjet_subleading_eta->Fill(p->QCDaGjetEtaSmallR_SD->at(j));
      ...
      h_gjet_multiplicity_eta->Fill(p->QCDaGjetMultSmallR_SD->at(j),p->QCDaGjetEtaSmallR_SD->at(j));
      h_gjet_ptD_eta->Fill(p->QCDaGjetpTDSmallR_SD->at(j),p->QCDaGjetEtaSmallR_SD->at(j));
      h_gjet_LHA_eta->Fill(p->QCDaGjetLHASmallR_SD->at(j),p->QCDaGjetEtaSmallR_SD->at(j));
      h_gjet_width_eta->Fill(p->QCDaGjetWidthSmallR_SD->at(j),p->QCDaGjetEtaSmallR_SD->at(j));
      h_gjet_mass_eta->Fill(p->QCDaGjetMassSmallR_SD->at(j),p->QCDaGjetEtaSmallR_SD->at(j));
	...
	if (p->JsmallPt->at(l) < 20) continue;
      ...
      h_gjet_multiplicity_nearestdR->Fill(p->QCDaGjetMultSmallR_SD->at(j),dRmin);
      h_gjet_ptD_nearestdR->Fill(p->QCDaGjetpTDSmallR_SD->at(j),dRmin);
      h_gjet_LHA_nearestdR->Fill(p->QCDaGjetLHASmallR_SD->at(j),dRmin);
      h_gjet_width_nearestdR->Fill(p->QCDaGjetWidthSmallR_SD->at(j),dRmin);
      h_gjet_mass_nearestdR->Fill(p->QCDaGjetMassSmallR_SD->at(j),dRmin);
    }
