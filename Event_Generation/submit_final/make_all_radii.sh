...
./submit_jobs.sh ${jobname}_R0p2 ${jobname}_R0p2 ${nevents} ${process} 0.2 ${hmass} ${ptmin} ${ptmax} ${minpt}
./submit_jobs.sh ${jobname}_R0p3 ${jobname}_R0p3 ${nevents} ${process} 0.3 ${hmass} ${ptmin} ${ptmax} ${minpt}
