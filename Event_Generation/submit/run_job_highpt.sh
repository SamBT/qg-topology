...
mkdir /project/projectdirs/atlas/sambt/Pythia_output/pthat_min200_max400/${jobname}

mv ${filename}.root /project/projectdirs/atlas/sambt/Pythia_output/pthat_min200_max400/${jobname}/${filename}_${j}.root
