void qjet_vs_gjet_samesample(TString type, TString var, TString xlabel, int rebin, int logscale) {
  TString filename;
  if (type == "gg2Hg") filename = "/global/homes/s/sambt/Jets/qg_tagging_topology_project/analysis/analysis_output/Radius_1/output_gg2Hg_rewt.root";
  if (type == "qqbar2Zg") filename = "/global/homes/s/sambt/Jets/qg_tagging_topology_project/analysis/analysis_output/Radius_1/output_qqbar2Zg_rewt.root";
