void samejet_diffsample(TString type, TString var, TString xlabel, int rebin, int logscale) {
  TFile *f1 = TFile::Open("/global/homes/s/sambt/Jets/qg_tagging_topology_project/analysis/analysis_output/Radius_06/output_dijets_rewt.root");
  TFile *f2 = TFile::Open("/global/homes/s/sambt/Jets/qg_tagging_topology_project/analysis/analysis_output/Radius_06/output_zplusjets.root");
