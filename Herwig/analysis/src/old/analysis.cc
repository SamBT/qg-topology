...
int main (int argc, char **argv) {
  ...
  for( int i = 0 ; i < numev ; i ++ ) {	
    ...
    for (int k = 0; k < p->NQjetsSmallR; k++) {
      test_hist_q->Fill(p->QjetLHASmallR->at(k));
      if (p->QjetPtSmallR->at(k) < 20 || fabs(p->QjetEtaSmallR->at(k)) > 2.0) continue;
      h_qjet_pt->Fill(p->QjetPtSmallR->at(k));
      h_qjet_eta->Fill(p->QjetEtaSmallR->at(k));
      h_qjet_phi->Fill(p->QjetPhiSmallR->at(k));
      h_qjet_M->Fill(p->QjetMSmallR->at(k));
      h_qjet_multiplicity->Fill(p->QjetMultSmallR->at(k));
      h_qjet_ptD->Fill(p->QjetpTDSmallR->at(k));
      h_qjet_LHA->Fill(p->QjetLHASmallR->at(k));
      h_qjet_width->Fill(p->QjetWidthSmallR->at(k));
      h_qjet_mass->Fill(p->QjetMassSmallR->at(k));

      if (k == 0) {
	h_qjet_leading_multiplicity->Fill(p->QjetMultSmallR->at(k));
	h_qjet_leading_ptD->Fill(p->QjetpTDSmallR->at(k));
	h_qjet_leading_LHA->Fill(p->QjetLHASmallR->at(k));
	h_qjet_leading_width->Fill(p->QjetWidthSmallR->at(k));
	h_qjet_leading_mass->Fill(p->QjetMassSmallR->at(k));
	h_qjet_leading_eta->Fill(p->QjetEtaSmallR->at(k));
	h_qjet_leading_pt->Fill(p->QjetPtSmallR->at(k));
      }
      if (k == 1) {
	h_qjet_subleading_multiplicity->Fill(p->QjetMultSmallR->at(k));
	h_qjet_subleading_ptD->Fill(p->QjetpTDSmallR->at(k));
	h_qjet_subleading_LHA->Fill(p->QjetLHASmallR->at(k));
	h_qjet_subleading_width->Fill(p->QjetWidthSmallR->at(k));
	h_qjet_subleading_mass->Fill(p->QjetMassSmallR->at(k));
	h_qjet_subleading_eta->Fill(p->QjetEtaSmallR->at(k));
	h_qjet_subleading_pt->Fill(p->QjetPtSmallR->at(k));
      }

      h_qjet_multiplicity_eta->Fill(p->QjetMultSmallR->at(k),p->QjetEtaSmallR->at(k));
      h_qjet_ptD_eta->Fill(p->QjetpTDSmallR->at(k),p->QjetEtaSmallR->at(k));
      h_qjet_LHA_eta->Fill(p->QjetLHASmallR->at(k),p->QjetEtaSmallR->at(k));
      h_qjet_width_eta->Fill(p->QjetWidthSmallR->at(k),p->QjetEtaSmallR->at(k));
      h_qjet_mass_eta->Fill(p->QjetMassSmallR->at(k),p->QjetEtaSmallR->at(k));
	...
	if (p->JsmallPt->at(l) < 20) continue;
      ...
      h_qjet_multiplicity_nearestdR->Fill(p->QjetMultSmallR->at(k),dRmin);
      h_qjet_ptD_nearestdR->Fill(p->QjetpTDSmallR->at(k),dRmin);
      h_qjet_LHA_nearestdR->Fill(p->QjetLHASmallR->at(k),dRmin);
      h_qjet_width_nearestdR->Fill(p->QjetWidthSmallR->at(k),dRmin);
      h_qjet_mass_nearestdR->Fill(p->QjetMassSmallR->at(k),dRmin);
    }

    for (int j = 0; j < p->NGjetsSmallR; j++) {
      if (p->GjetPtSmallR->at(j) < 20 || fabs(p->GjetEtaSmallR->at(j)) > 2.0) continue;
      h_gjet_pt->Fill(p->GjetPtSmallR->at(j));
      h_gjet_eta->Fill(p->GjetEtaSmallR->at(j));
      h_gjet_phi->Fill(p->GjetPhiSmallR->at(j));
      h_gjet_M->Fill(p->GjetMSmallR->at(j));
      h_gjet_multiplicity->Fill(p->GjetMultSmallR->at(j));
      h_gjet_ptD->Fill(p->GjetpTDSmallR->at(j));
      h_gjet_LHA->Fill(p->GjetLHASmallR->at(j));
      h_gjet_width->Fill(p->GjetWidthSmallR->at(j));
      h_gjet_mass->Fill(p->GjetMassSmallR->at(j));
      
      if (j == 0) {
	h_gjet_leading_multiplicity->Fill(p->GjetMultSmallR->at(j));
	h_gjet_leading_ptD->Fill(p->GjetpTDSmallR->at(j));
	h_gjet_leading_LHA->Fill(p->GjetLHASmallR->at(j));
	h_gjet_leading_width->Fill(p->GjetWidthSmallR->at(j));
	h_gjet_leading_mass->Fill(p->GjetMassSmallR->at(j));
	h_gjet_leading_eta->Fill(p->GjetEtaSmallR->at(j));
	h_gjet_leading_pt->Fill(p->GjetPtSmallR->at(j));
      }
      if (j == 1) {
	h_gjet_subleading_multiplicity->Fill(p->GjetMultSmallR->at(j));
	h_gjet_subleading_ptD->Fill(p->GjetpTDSmallR->at(j));
	h_gjet_subleading_LHA->Fill(p->GjetLHASmallR->at(j));
	h_gjet_subleading_width->Fill(p->GjetWidthSmallR->at(j));
	h_gjet_subleading_mass->Fill(p->GjetMassSmallR->at(j));
	h_gjet_subleading_eta->Fill(p->GjetEtaSmallR->at(j));
        h_gjet_subleading_pt->Fill(p->GjetPtSmallR->at(j));
      }

      h_gjet_multiplicity_eta->Fill(p->GjetMultSmallR->at(j),p->GjetEtaSmallR->at(j));
      h_gjet_ptD_eta->Fill(p->GjetpTDSmallR->at(j),p->GjetEtaSmallR->at(j));
      h_gjet_LHA_eta->Fill(p->GjetLHASmallR->at(j),p->GjetEtaSmallR->at(j));
      h_gjet_width_eta->Fill(p->GjetWidthSmallR->at(j),p->GjetEtaSmallR->at(j));
      h_gjet_mass_eta->Fill(p->GjetMassSmallR->at(j),p->GjetEtaSmallR->at(j));
	...
	if (p->JsmallPt->at(l) < 20) continue;
      ...
      h_gjet_multiplicity_nearestdR->Fill(p->GjetMultSmallR->at(j),dRmin);
      h_gjet_ptD_nearestdR->Fill(p->GjetpTDSmallR->at(j),dRmin);
      h_gjet_LHA_nearestdR->Fill(p->GjetLHASmallR->at(j),dRmin);
      h_gjet_width_nearestdR->Fill(p->GjetWidthSmallR->at(j),dRmin);
      h_gjet_mass_nearestdR->Fill(p->GjetMassSmallR->at(j),dRmin);
    }
    
    
  }

  cout << "number of jets where nqjets + ngjets != njets is " << bad_counter << endl;
