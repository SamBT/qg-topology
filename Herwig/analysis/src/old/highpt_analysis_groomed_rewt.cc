...
int main (int argc, char **argv) {
  ...
  for( int i = 0 ; i < numev ; i ++ ) {	
	...
	if (p->QjetEtaSmallR->at(k) > qjet_eta_denom->GetBinLowEdge(r) && p->QjetEtaSmallR->at(k) < qjet_eta_denom->GetBinLowEdge(r) + qjet_eta_denom->GetBinWidth(r)) {
      ...
      if (k == 0) {
	h_qjet_leading_pt->Fill(p->QjetPtSmallR_SD->at(k),leading_wt_pt);
	h_qjet_leading_eta->Fill(p->QjetEtaSmallR_SD->at(k),leading_wt_eta);
	h_qjet_leading_multiplicity->Fill(p->QjetMultSmallR_SD->at(k), leading_wt);
	h_qjet_leading_ptD->Fill(p->QjetpTDSmallR_SD->at(k),leading_wt);
	h_qjet_leading_LHA->Fill(p->QjetLHASmallR_SD->at(k),leading_wt);
	h_qjet_leading_width->Fill(p->QjetWidthSmallR_SD->at(k),leading_wt);
	h_qjet_leading_mass->Fill(p->QjetMassSmallR_SD->at(k),leading_wt);
      }
      if (k == 1) {
	h_qjet_subleading_pt->Fill(p->QjetPtSmallR_SD->at(k),subleading_wt_pt);
	h_qjet_subleading_eta->Fill(p->QjetEtaSmallR_SD->at(k),subleading_wt_eta);
	h_qjet_subleading_multiplicity->Fill(p->QjetMultSmallR_SD->at(k),subleading_wt);
	h_qjet_subleading_ptD->Fill(p->QjetpTDSmallR_SD->at(k),subleading_wt);
	h_qjet_subleading_LHA->Fill(p->QjetLHASmallR_SD->at(k),subleading_wt);
	h_qjet_subleading_width->Fill(p->QjetWidthSmallR_SD->at(k),subleading_wt);
	h_qjet_subleading_mass->Fill(p->QjetMassSmallR_SD->at(k),subleading_wt);
      }

      h_qjet_pt->Fill(p->QjetPtSmallR_SD->at(k),wt_pt);
      h_qjet_eta->Fill(p->QjetEtaSmallR_SD->at(k),wt_eta);
      h_qjet_phi->Fill(p->QjetPhiSmallR_SD->at(k),wt);
      h_qjet_M->Fill(p->QjetMSmallR_SD->at(k),wt);
      h_qjet_multiplicity->Fill(p->QjetMultSmallR_SD->at(k), wt);
      h_qjet_ptD->Fill(p->QjetpTDSmallR_SD->at(k),wt);
      h_qjet_LHA->Fill(p->QjetLHASmallR_SD->at(k),wt);
      h_qjet_width->Fill(p->QjetWidthSmallR_SD->at(k),wt);
      h_qjet_mass->Fill(p->QjetMassSmallR_SD->at(k),wt);

      h_qjet_multiplicity_eta->Fill(p->QjetMultSmallR_SD->at(k),p->QjetEtaSmallR_SD->at(k),wt);
      h_qjet_ptD_eta->Fill(p->QjetpTDSmallR_SD->at(k),p->QjetEtaSmallR_SD->at(k),wt);
      h_qjet_LHA_eta->Fill(p->QjetLHASmallR_SD->at(k),p->QjetEtaSmallR_SD->at(k),wt);
      h_qjet_width_eta->Fill(p->QjetWidthSmallR_SD->at(k),p->QjetEtaSmallR_SD->at(k),wt);
      h_qjet_mass_eta->Fill(p->QjetMassSmallR_SD->at(k),p->QjetEtaSmallR_SD->at(k),wt);
	...
	if (p->JsmallPt->at(l) < 20) continue;
      ...
      h_qjet_multiplicity_nearestdR->Fill(p->QjetMultSmallR_SD->at(k),dRmin,wt);
      h_qjet_ptD_nearestdR->Fill(p->QjetpTDSmallR_SD->at(k),dRmin,wt);
      h_qjet_LHA_nearestdR->Fill(p->QjetLHASmallR_SD->at(k),dRmin,wt);
      h_qjet_width_nearestdR->Fill(p->QjetWidthSmallR_SD->at(k),dRmin,wt);
      h_qjet_mass_nearestdR->Fill(p->QjetMassSmallR_SD->at(k),dRmin,wt);
    }
    ...
    for (int j = 0; j < p->NGjetsSmallR; j++) {
      ...
      if (j == 0) {
	h_gjet_leading_pt->Fill(p->GjetPtSmallR_SD->at(j),wt_pt);
        h_gjet_leading_eta->Fill(p->GjetEtaSmallR_SD->at(j),wt_eta);
        h_gjet_leading_multiplicity->Fill(p->GjetMultSmallR_SD->at(j), wt);
        h_gjet_leading_ptD->Fill(p->GjetpTDSmallR_SD->at(j),wt);
        h_gjet_leading_LHA->Fill(p->GjetLHASmallR_SD->at(j),wt);
        h_gjet_leading_width->Fill(p->GjetWidthSmallR_SD->at(j),wt);
        h_gjet_leading_mass->Fill(p->GjetMassSmallR_SD->at(j),wt);
      } 
      if (j == 1) {
	h_gjet_subleading_pt->Fill(p->GjetPtSmallR_SD->at(j),wt_pt);
        h_gjet_subleading_eta->Fill(p->GjetEtaSmallR_SD->at(j),wt_eta);
        h_gjet_subleading_multiplicity->Fill(p->GjetMultSmallR_SD->at(j),wt);
        h_gjet_subleading_ptD->Fill(p->GjetpTDSmallR_SD->at(j),wt);
        h_gjet_subleading_LHA->Fill(p->GjetLHASmallR_SD->at(j),wt);
        h_gjet_subleading_width->Fill(p->GjetWidthSmallR_SD->at(j),wt);
        h_gjet_subleading_mass->Fill(p->GjetMassSmallR_SD->at(j),wt);
      }

      h_gjet_pt->Fill(p->GjetPtSmallR_SD->at(j),wt_pt);
      h_gjet_eta->Fill(p->GjetEtaSmallR_SD->at(j),wt_eta);
      h_gjet_phi->Fill(p->GjetPhiSmallR_SD->at(j),wt);
      h_gjet_M->Fill(p->GjetMSmallR_SD->at(j),wt);
      h_gjet_multiplicity->Fill(p->GjetMultSmallR_SD->at(j),wt);
      h_gjet_ptD->Fill(p->GjetpTDSmallR_SD->at(j),wt);
      h_gjet_LHA->Fill(p->GjetLHASmallR_SD->at(j),wt);
      h_gjet_width->Fill(p->GjetWidthSmallR_SD->at(j),wt);
      h_gjet_mass->Fill(p->GjetMassSmallR_SD->at(j),wt);

      h_gjet_multiplicity_eta->Fill(p->GjetMultSmallR_SD->at(j),p->GjetEtaSmallR_SD->at(j),wt);
      h_gjet_ptD_eta->Fill(p->GjetpTDSmallR_SD->at(j),p->GjetEtaSmallR_SD->at(j),wt);
      h_gjet_LHA_eta->Fill(p->GjetLHASmallR_SD->at(j),p->GjetEtaSmallR_SD->at(j),wt);
      h_gjet_width_eta->Fill(p->GjetWidthSmallR_SD->at(j),p->GjetEtaSmallR_SD->at(j),wt);
      h_gjet_mass_eta->Fill(p->GjetMassSmallR_SD->at(j),p->GjetEtaSmallR_SD->at(j),wt);
	...
	if (p->JsmallPt->at(l) < 20) continue;
      ...
      h_gjet_multiplicity_nearestdR->Fill(p->GjetMultSmallR_SD->at(j),dRmin,wt);
      h_gjet_ptD_nearestdR->Fill(p->GjetpTDSmallR_SD->at(j),dRmin,wt);
      h_gjet_LHA_nearestdR->Fill(p->GjetLHASmallR_SD->at(j),dRmin,wt);
      h_gjet_width_nearestdR->Fill(p->GjetWidthSmallR_SD->at(j),dRmin,wt);
      h_gjet_mass_nearestdR->Fill(p->GjetMassSmallR_SD->at(j),dRmin,wt);
    }
