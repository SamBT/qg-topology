...
C     
C     Process: g u > z u WEIGHTED<=3 @1
C     *   Decay: z > ve ve~ WEIGHTED<=2
C     Process: g c > z c WEIGHTED<=3 @1
C     *   Decay: z > ve ve~ WEIGHTED<=2
C     Process: g u > z u WEIGHTED<=3 @1
C     *   Decay: z > vm vm~ WEIGHTED<=2
C     Process: g c > z c WEIGHTED<=3 @1
C     *   Decay: z > vm vm~ WEIGHTED<=2
C     Process: g u > z u WEIGHTED<=3 @1
C     *   Decay: z > vt vt~ WEIGHTED<=2
C     Process: g c > z c WEIGHTED<=3 @1
C     *   Decay: z > vt vt~ WEIGHTED<=2
C     Process: g d > z d WEIGHTED<=3 @1
C     *   Decay: z > ve ve~ WEIGHTED<=2
C     Process: g s > z s WEIGHTED<=3 @1
C     *   Decay: z > ve ve~ WEIGHTED<=2
C     Process: g d > z d WEIGHTED<=3 @1
C     *   Decay: z > vm vm~ WEIGHTED<=2
C     Process: g s > z s WEIGHTED<=3 @1
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g u > ve ve~ u
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! g d > ve ve~ d
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! g u~ > ve ve~ u~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! g d~ > ve ve~ d~
      ENDIF
