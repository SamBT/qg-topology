...
C     
C     Process: d d~ > z g WEIGHTED<=3 @1
C     *   Decay: z > ve ve~ WEIGHTED<=2
C     Process: s s~ > z g WEIGHTED<=3 @1
C     *   Decay: z > ve ve~ WEIGHTED<=2
C     Process: d d~ > z g WEIGHTED<=3 @1
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,5),-GC_51,GC_58,AMP(1))
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,1),W(1,3),W(1,5),-GC_51,GC_58,AMP(2))
