...
C     *   Decay: h > g g HIG<=1 HIW<=1 WEIGHTED<=2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      DATA DENOM(1)/3/
      DATA (CF(I,  1),I=  1,  2) /   14,   -4/
C     1 Tr(1,2,5) Tr(3,4)
      DATA DENOM(2)/3/
      DATA (CF(I,  2),I=  1,  2) /   -4,   14/
C     1 Tr(1,5,2) Tr(3,4)
C     ----------
C     BEGIN CODE
C     ----------
      ...
      CALL VVS3_3(W(1,3),W(1,4),GC_13,MDL_MH,MDL_WH,W(1,5))
      CALL VXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
C     Amplitude(s) for diagram number 1
      CALL VVVS2_0(W(1,1),W(1,2),W(1,4),W(1,5),GC_14,AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,4),W(1,3),W(1,5),GC_13,AMP(2))
      CALL VVS3P0_1(W(1,1),W(1,5),GC_13,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,2),W(1,4),W(1,3),GC_10,AMP(3))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL VVS3_0(W(1,2),W(1,3),W(1,5),GC_13,AMP(4))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+4D0*(-IMAG1*AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(3)+IMAG1
     $ *AMP(4))
      JAMP(2,1)=+4D0*(+IMAG1*AMP(1)+IMAG1*AMP(2)+IMAG1*AMP(3)-IMAG1
     $ *AMP(4))
