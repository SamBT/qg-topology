...
C     
C     Process: g u > h u HIG<=1 HIW<=1 WEIGHTED<=3 @2
C     *   Decay: h > g g HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: g c > h c HIG<=1 HIW<=1 WEIGHTED<=3 @2
C     *   Decay: h > g g HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: g d > h d HIG<=1 HIW<=1 WEIGHTED<=3 @2
C     *   Decay: h > g g HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: g s > h s HIG<=1 HIW<=1 WEIGHTED<=3 @2
C     *   Decay: h > g g HIG<=1 HIW<=1 WEIGHTED<=2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,4),W(1,3),GC_11,AMP(1))
