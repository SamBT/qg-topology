...
C     
     ...
     $ * W1))
      V1(3)= DENOM*S3(3)*(-CI*(P2(0)*TMP4)+CI*(V2(3)*TMP9))
      V1(4)= DENOM*S3(3)*(-CI*(P2(1)*TMP4)+CI*(V2(4)*TMP9))
      V1(5)= DENOM*S3(3)*(-CI*(P2(2)*TMP4)+CI*(V2(5)*TMP9))
      V1(6)= DENOM*S3(3)*(-CI*(P2(3)*TMP4)+CI*(V2(6)*TMP9))
      END
